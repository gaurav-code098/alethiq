...
// 🟢 FIX: Added break-words and whitespace control to all text components
               ...
               <div className="space-y-20">
                 {chatHistory.map((msg, idx) => (
                   <div key={idx} className="group">
                       {msg.type === 'user' ? (
                         <h2 className="text-2xl md:text-4xl font-light text-white/90 tracking-tight mb-8 leading-snug break-words">{msg.content}</h2>
                       ) : (
